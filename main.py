...
from engines.empregos import get_empregos_jobs
...
getters = cycle([get_empregos_jobs, get_gupy_jobs, get_hipsters_jobs,get_infojobs_jobs, get_programathor_jobs, get_vagas_jobs])
fields = ['LINK', 'TITULO DA VAGA', 'EMPRESA', 'LOCALIDADE', 'MODALIDADE DE TRABALHO','REGIME', 'SALÁRIO', 'DATA DE PUBLICAÇÃO']
