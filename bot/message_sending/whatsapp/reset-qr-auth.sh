...
# Script para reset da autenticação do Sonar Bot
# Autor: Dev Gui
# Versão: 0.9.0-BETA

echo "🤖 Sonar Bot - Reset da Autenticação"
echo "====================================="
echo ""

if [ ! -d "assets" ]; then
    echo "❌ Erro: Você deve executar este script no diretório raiz do Sonar Bot"
