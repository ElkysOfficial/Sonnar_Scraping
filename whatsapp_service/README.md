...
![Sonar Bot](./assets/images/takeshi-bot.png)
...
## 🌐 Acesse o Sonar Bot em outros idiomas
...
O Sonar Bot possui um auto-responder embutido, edite o arquivo em `./database/auto-responder.json`:
...
O Sonar Bot possui um recurso de auto-figurinha que converte automaticamente imagens e vídeos enviados em figurinhas:
...
O Sonar Bot é um projeto **open source** e sua contribuição é muito bem-vinda!
