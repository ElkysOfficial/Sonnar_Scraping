...
export default {
  ...
  handle: async ({ sendReply, sendImageFromFile, sendReact, userLid }) => {
    ...
    await sendImageFromFile(path.join(ASSETS_DIR, "samples", "sample-image.jpg"), "Esta é uma legenda opcional para a imagem")
    ...
    await sendImageFromFile(path.join(ASSETS_DIR, "samples", "sample-image.jpg"))
    ...
    await sendImageFromFile(path.join(ASSETS_DIR, "images", "takeshi-bot.png"), "Logo do Sonar Bot!")
    ...
    await sendImageFromFile(path.join(ASSETS_DIR, "images", "takeshi-bot.png"), `Logo do Sonar Bot para você @${userLid.split("@")[0]}!`, [userLid])
