...
export default {
  ...
  handle: async ({ sendReply, sendImageFromURL, sendReact, userLid }) => {
    ...
    await sendImageFromURL("https://api.spiderx.com.br/storage/samples/sample-image.jpg", "Esta é uma legenda para a imagem da URL")
    ...
    await sendImageFromURL("https://api.spiderx.com.br/storage/samples/sample-image.jpg")
    ...
    await sendImageFromURL("https://api.spiderx.com.br/storage/samples/sample-image.jpg", `Logo do Sonar Bot para você ${userLid.split("@")[0]}!`, [userLid])
